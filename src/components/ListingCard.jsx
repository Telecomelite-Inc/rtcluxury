      ...
      {onInquire && (
        <div className="px-5 pb-5 pt-4">
          <button
            ...
            className="w-full rounded-full border border-emerald-900 py-2 text-xs font-semibold uppercase tracking-wide text-emerald-900 transition hover:bg-emerald-900 hover:text-cream"
          >
            Inquire
          </button>
        </div>
